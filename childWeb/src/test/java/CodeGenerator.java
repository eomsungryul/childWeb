...
public class CodeGenerator {
    ...
    private static final String JDBC_URL = "jdbc:mysql://52.79.240.67:3306/child?useSSL=false&amp;serverTimezone=UTC";
    private static final String JDBC_USERNAME = "child";
    ...
    public static void main(String[] args) {
    	...
    	genCode("child_qr_code");
    	genCode("child");
    	genCode("center_duty_manage");
    	genCode("center");
    	genCode("event_check");
    	genCode("class_daily_event");
    	genCode("class");
